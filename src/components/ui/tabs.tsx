  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "group-data-[variant=line]/tabs-list:bg-transparent group-data-[variant=line]/tabs-list:data-active:bg-transparent group-data-[variant=line]/tabs-list:data-active:shadow-none group-data-[variant=line]/tabs-list:data-active:ring-0 dark:group-data-[variant=line]/tabs-list:data-active:border-transparent dark:group-data-[variant=line]/tabs-list:data-active:bg-transparent",
        "data-active:bg-[image:var(--surface-wash-selected)] data-active:bg-background data-active:text-foreground data-active:shadow-(--shadow-surface-selected) data-active:ring-1 data-active:ring-primary/20 dark:data-active:border-transparent dark:data-active:bg-[image:var(--surface-wash-selected)] dark:data-active:text-foreground",
